...
- **deps:** upgrade React Native to 0.87.1 to remove the image-size CVE ([#199](https://github.com/grafana/faro-react-native-sdk/issues/199)) ([acd6708](https://github.com/grafana/faro-react-native-sdk/commit/acd67089ab6880eae508f21511d15e69419dda3f))
...
- **android:** avoid duplicate protobuf source registration ([#202](https://github.com/grafana/faro-react-native-sdk/issues/202)) ([68b49b8](https://github.com/grafana/faro-react-native-sdk/commit/68b49b869d1119df2d49e2067ff846a8df31070f))
...
- **deps:** update dependency androidx.test:core to v1.7.0 ([#171](https://github.com/grafana/faro-react-native-sdk/issues/171)) ([bb6b9bd](https://github.com/grafana/faro-react-native-sdk/commit/bb6b9bdbe36a6a0295c26ff1222e059b7880d710))
- **deps:** update dependency com.google.protobuf:protobuf-gradle-plugin to v0.10.0 ([#172](https://github.com/grafana/faro-react-native-sdk/issues/172)) ([c54fea2](https://github.com/grafana/faro-react-native-sdk/commit/c54fea2ad323f881a094535f6e0fd5e818ae280c))
- **deps:** update dependency org.jetbrains.kotlin:kotlin-stdlib to v1.9.25 ([#174](https://github.com/grafana/faro-react-native-sdk/issues/174)) ([b19090a](https://github.com/grafana/faro-react-native-sdk/commit/b19090adb729ecb92c3bf9b1c8daa38b895a3335))
- **deps:** update dependency org.robolectric:robolectric to v4.17 ([#173](https://github.com/grafana/faro-react-native-sdk/issues/173)) ([284de8c](https://github.com/grafana/faro-react-native-sdk/commit/284de8cb422a648de637780970a42967c19d7307))
...
- **security/medium/packages/react-native/android:** update dependency org.jetbrains.kotlin:kotlin-gradle-plugin to v2 [security] ([#192](https://github.com/grafana/faro-react-native-sdk/issues/192)) ([78e36d2](https://github.com/grafana/faro-react-native-sdk/commit/78e36d250cdc50042f8412afbedd56d2f5d63a4b))
...
- Calling `SessionInstrumentation.destroy()` or `unpatch()` now removes its
  ...
  New telemetry created after teardown is no longer filtered by the removed
  instrumentation. With no replacement active, queued items still apply their
  captured sampling decision and strip internal sampling metadata. Any retained
...
- Recovered iOS native crashes retain their crash-time Faro session and remain
  pending until delivery succeeds. Reports without usable crash-time session
  context are discarded instead of being assigned to the restarted session.
